                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           Authors Listing
                           <div class="col-md-24" style="float:right;">
                                <button class="btn btn-success" onclick="Add()"> Add Authors </button>
                            </div>
                        </div>
...
<script>
    ...
    // Redirect the user to a specific URL
        window.location.href = 'http://localhost/secure/library/admin/add-author.php';
        }
        </script>
<?php } ?>